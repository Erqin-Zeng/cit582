...
contract AMM is AccessControl{
	...
	*/
    ...
    if (sellToken == tokenA) {    
      ...
      qtyB = ERC20(tokenB).balanceOf(address(this)) - invariant/(ERC20(tokenA).balanceOf(address(this))+sellAmount);
      swapAmt = ((10000-feebps)/10000)*qtyB;    
    ...
    if (sellToken == tokenB) {  
      ...
      //qtyB = ((10000-feebps)/10000)*sellAmount;      
			qtyA = ERC20(tokenA).balanceOf(address(this)) - invariant/(ERC20(tokenB).balanceOf(address(this))+sellAmount);
